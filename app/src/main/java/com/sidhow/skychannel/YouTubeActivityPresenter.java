...
public class YouTubeActivityPresenter {
    ...
    public void getAllSubscribedChannels(GoogleAccountCredential credential, OnGetSubscribedChannelList onGetSubscribedChannelList){
        new GetSubscribedChannels(credential,onGetSubscribedChannelList).execute();
    }

    private class GetSubscribedChannels  extends AsyncTask<Object, Object, SubscriptionListResponse> {
        private YouTube mService = null;
        private OnGetSubscribedChannelList onGetSubscribedChannelList;
        GetSubscribedChannels(GoogleAccountCredential credential, OnGetSubscribedChannelList onGetSubscribedChannelList) {
            this.onGetSubscribedChannelList = onGetSubscribedChannelList;
        ...
        protected SubscriptionListResponse doInBackground(Object... params) {
            ...
            try {
                YouTube.Subscriptions.List request = mService.subscriptions()
                        .list("snippet");
        ...
        protected void onPostExecute(SubscriptionListResponse subscriptionListResponse) {
            super.onPostExecute(subscriptionListResponse);
            if(subscriptionListResponse!=null){
                onGetSubscribedChannelList.onGetSubscribedChannelList(true,subscriptionListResponse.getItems());
            }else{
                onGetSubscribedChannelList.onGetSubscribedChannelList(false, Collections.emptyList());
            }
        }
    }
