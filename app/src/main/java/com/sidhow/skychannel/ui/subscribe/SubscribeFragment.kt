package com.sidhow.skychannel.ui.subscribe
...
import com.sidhow.skychannel.databinding.FragmentSubscribeBinding
...
class SubscribeFragment : Fragment(), PermissionCallbacks, YouTubeActivityView {
    ...
    override fun onCreateView(
        ...
        presenter = YouTubeActivityPresenter(
            this,
            requireActivity()
        )
...
//            },500)
    ...
    private fun getResultsFromApi() {
        if (!isGooglePlayServicesAvailable()) {
            ...
            initpDialog(context, "Subscribing the channel")
            showpDialog()
